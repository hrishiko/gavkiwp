...
class WMC_Widget_Converter extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			...
			esc_attr__( 'Woo Currency Converter', 'woo-multi-currency' ), // Name
			array( 'description' => esc_attr__( 'Convert your currency', 'woo-multi-currency' ), ) // Args
		);
	}
	...
	public function form( $instance ) {
		$title = ! empty( $instance['title'] ) ? $instance['title'] : esc_attr__( 'Convert Your Currency', 'woo-multi-currency' );
		?>
		<p>
