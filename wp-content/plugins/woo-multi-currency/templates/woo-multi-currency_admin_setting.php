...
?>
	<input type="button" value="<?php esc_attr_e( 'Add currency', 'woo-multi-currency' ); ?>" id="btn_add_curr"
		   class="button" />
	<input type="button" value="<?php esc_attr_e( 'Get All Exchange', 'woo-multi-currency' ); ?>"
		   id="btn_get_all_exchange" class="button" />
		...
		<?php foreach ( $selected_currencies as $code => $values ) { ?>
			<div class="wmc_wrap">
				<img src="<?php echo plugins_url() . "/woo-multi-currency/images/dragndrop.png"; ?>" alt="Move to Sort"
					 class="wmc_img">
				<input name="wmc_is_main[]" id="wmc_is_main" class="wmc_is_main wmc_is_main_css"
				...
				<select name="wmc_pos[]" id="wmc_pos" class="wc-enhanced-select wmc_pos_css  wmc_select2">
					<option
				...
				<input id="wmc_rate" name="wmc_rate[]" type="text"
					   ...
					   class="wmc_rate wmc_rate_css" data-tip="Manual enter your exchange rate here">
	...
	<div id="temcurrency" style="display:none">
		<div class="wmc_wrap">
			<img src="<?php echo plugins_url() . "/woo-multi-currency/images/dragndrop.png"; ?>" alt="Move to Sort"
				 class="wmc_img">
			<input name="temp_wmc_is_main" id="temp_wmc_is_main" type="radio" class="tem_wmc_is_main wmc_is_main_css"
