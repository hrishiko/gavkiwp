	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-lg-6 col-md-7 col-sm-9">
				...
				<nav class="topbar no-mobile-advanced"><?php echo SHOPME_HELPER::main_navigation('Topbar Menu', '', 'topbar'); ?></nav>
		...
		<div class="row">
			...
			<div class="col-xs-12">
				...
				<nav class="full_width_nav">
					<?php echo SHOPME_HELPER::main_navigation('Fullwidth Menu', '', 'fullwidth'); ?>
				</nav><!--/ .main_navigation-->
