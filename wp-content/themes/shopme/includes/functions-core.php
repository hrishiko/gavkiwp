...
if ( !function_exists('shopme_locate_template') ) {
    ...
    function shopme_locate_template( $path ) {
        $path = ltrim( $path, '/' );
		$theme_path = str_replace( SHOPME_BASE_PATH, '', SHOPME_TEMPLATES_PATH . $path );
...
if ( !function_exists('shopme_get_template') ) {
    ...
    function shopme_get_template( $path, $var = null, $return = false ) {

        $located = shopme_locate_template( $path );
