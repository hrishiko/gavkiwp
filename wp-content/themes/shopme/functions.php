...
define('SHOPME_TEMPLATES_PATH', SHOPME_INCLUDES_PATH . 'templates/');
define('SHOPME_TEMPLATES_URL',  SHOPME_INCLUDES_URI . trailingslashit('templates'));
...
if (class_exists('WooCommerce')) {
	...
	if ( ! function_exists('shopme_woo_config') ) {
		...
		function shopme_woo_config() {
			// Load required classes and functions
			require_once( SHOPME_BASE_PATH . 'config-woocommerce/config.php' );
	 ...
	 * Instance main plugin class
	 */
	global $shopme_woo_config;
	$shopme_woo_config = shopme_woo_config();
}
