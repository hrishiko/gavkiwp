...
if (!class_exists('SHOPME_WOOCOMMERCE_CONFIG')) {
	...
	class SHOPME_WOOCOMMERCE_CONFIG {
		...
		function __construct() {
			...
			require_once( $this->paths['PHP'] . 'templates-hooks.php' );
			require_once( $this->paths['PHP'] . 'ordering.class.php' );
			require_once( $this->paths['PHP'] . 'new-badge.class.php' );
		...
		public function woocommerce_set_defaults() {
			...
			$shopme_config['themeImgSizes']['shop_catalog']   = array('width' => 245, 'height' => 245);
			$shopme_config['themeImgSizes']['shop_single']    = array('width'=> 360, 'height'=> 360);
